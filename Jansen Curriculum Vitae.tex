...
\section*{Education}
	\begin{description}
		\item [2014 - 2018] Ph.D. Candidate, Arizona State University, Evolutionary Biology.
...
\section*{Manuscripts in Preparation}
	\begin{description}
		\itemsep0.5em
		\item \textbf{Jansen, M.A.}, Singh, S.S., Chawla, N., \& N.M. Franz. Microstructure-derived toughness in the acorn weevil exoskeleton. \textit{Nature Materials - In Prep}.
	\end{description}
...
\section*{Products Developed}
	...
	\subsection*{Patent Applications}
		\begin{description}
			\itemsep0.5em
			\item Aukes, D., Amor, H.B., Luck, K., \textbf{Jansen, M.A.}, \& J. Campbell, \textit{inventors}; Arizona State University, Skysong Innovations, \textit{assignee}. 2018. United States patent application for systems and methods for rapid-prototyped robotic devices. \textit{US Patent Application in prep}. To be filed: 11 December 2018.
